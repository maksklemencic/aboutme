  ...
  return (
    <div className="App bg-gray-900 font-link flex flex-col ">
      ...
      <div className="flex flex-col pt-20" >
        <div ref={home} className=" scroll-m-12">
          <HeroSection />
        </div>
        <div ref={projects} className=" scroll-m-12 md:scroll-m-0">
          <Projects />
        </div>
        <div ref={stack} className=" scroll-m-12 md:scroll-m-0">
          <Skills />
        </div>
        <div ref={contact} className=" scroll-m-12 md:scroll-m-0">
          <Contact />
        </div>
      </div>
    </div>
